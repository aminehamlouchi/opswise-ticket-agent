...
from opswise.exporters import write_json, write_markdown
...
def build_parser() -> argparse.ArgumentParser:
    ...
    triage.add_argument("--out", default=Path("outputs/triage-report.md"), type=Path)
